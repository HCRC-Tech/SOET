<!--Here is a page for changing password for Admins when they have to put their old password and the put a new one
 ...
 <head>
     <title>Participant Password Change</title>
...
<div id="wrapper">
 ...
 <div class="msb" id="msb">
     <p class="text-center fs-2">SOET</p>
         ...
         <div class="btn-group-vertical" style=" margin-top:15%; width:100%">
             <ul class="nav flex-column" style="width:100%">
                ...
                <li class="nav-item">
                    <p><a class="text-dark nav-link active" aria-current="page"
                                              href="{{ url('/passwordchangeparticipant')}}"><img src="{{asset('assets/images/key.png')}}" width="25" height="25" class="d-inline-block align-right"> Change Password</a></p>
                </li>
                <!--Logout Option-->
                <li class="nav-item">
                    <p><a class="text-dark nav-link active" aria-current="page"
 ...
 <form method = "POST" action = "{{ url('/passwordchangeparticipantsave')}}" style="margin-left: -60px">
    @csrf
