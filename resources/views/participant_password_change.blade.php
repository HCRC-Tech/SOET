...
<p style = "text-align:center;color:red">Change your current password</p>
        <!--the form where Admin have to change the password-->
            <form onSubmit="return checkPassword(this)" method="POST" action="{{ url('/participantpasswordreset')}}"
                  style="margin-left: -60px">
            @csrf
            <!-- the box for current password-->
                <div style="width: 550px; margin-left:15cm; margin-top:0.5%">
                    <div class="mb-7 row">
                        <label for="inputFirstName" class="col-sm-4 col-form-label">Username: </label>
                        <div class="col-sm-5">
                            <input type="text" style="width:7cm"
