...
<h4 style = "text-align:center">Select Survey</h4>
<p style = "text-align:center;color:red">Please select a survey to fill</p>
</head>
        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-3">
                ...
                <!-- Box for Survey Selection-->
                    <div class="mb-3" style="margin-left:25%; margin-top: -0.2cm">
                    ...
                    <br><br>
                    <!-- Submission button-->
                    <button class="btn btn-danger btn-lg btn-block" style="margin-left: 45%; width: 4cm;margin-top:-0.9cm">Proceed</button>
                </form>
            </section>
        </section>
    </div>
