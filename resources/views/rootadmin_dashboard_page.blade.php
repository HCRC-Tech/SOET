...
<h4 style = "text-align:center;color:blue">Hello {{$name ?? ''}}</h4>
<h6 style = "text-align:center;color:blue">Here are your administration options!</h6>
 <!--<p><a class="text-dark nav-link active" aria-current="page"
    ...
    <ul class="lp" style="margin-top: 30px; margin-left: 10cm">
        ...
        <br>
         &nbsp;&nbsp;&nbsp;
        <li>
            <button style="width:3.5cm; margin-top: -20px" class="btn btn-danger" onclick="location.href='{{route('/addsurvey/create')}}'"><span><img
                        src="{{asset('assets/images/survey.png')}}" width="25" height="25"
                        class="d-inline-block align-right"> Create Survey
            </span></button>
        </li>
        ...
        &nbsp;&nbsp;&nbsp;
         <li>
            <button style="width:3.5cm;height:1.5cm;" class="btn btn-danger" onclick="location.href='{{route('/adminsurveyselection')}}'"><span><img
                        src="{{asset('assets/images/survey.png')}}" width="25" height="25"
                        class="d-inline-block align-right"> Fill Survey
            </span></button>
            &nbsp;&nbsp;&nbsp;
            <br>
        </li>
        &nbsp;&nbsp;&nbsp;         
         <li>
            <button style="width: 3.7cm" class="btn btn-danger" onclick="location.href='{{route('/adminregistration')}}'"><span><img
                        src="{{asset('assets/images/signup.png')}}" width="25" height="25"
                        class="d-inline-block align-right">Create Admin</span>
            </button>
        </li>
        <br>
        <li>
            <button style="width:3.5cm"class="btn btn-danger" onclick="location.href='{{route('/profilesearch')}}'"><span> <img
                        src="{{asset('assets/images/pen.png')}}" width="25" height="25"
                        class="d-inline-block align-right"> View Participant</span></button>
        </li>
        &nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;
        <li>
            <button style="width:3.5cm"class="btn btn-danger" onclick="location.href='{{route('/passwordchangeadmin')}}'"><span><img
        ...
        <li>
            <button style="width:3.5cm" class="btn btn-danger" onclick="location.href='{{route('/adminhelp')}}'"><span><img
        ...
        <br>
         <li>
            <button style="width:3.5cm;height:2.1cm"class="btn btn-danger" onclick="location.href='{{route('/passwordchangeparticipant')}}'"><span><img
                        src="{{asset('assets/images/key.png')}}" width="25" height="25"
                        class="d-inline-block align-right">Participant Password Reset</span></button>
        </li>
       
        <br>
        <li>
            <button style="width:3.5cm;height:2.1cm"class="btn btn-danger" onclick="location.href='{{route('/caregiverregistration')}}'"><span><img
                        src="{{asset('assets/images/key.png')}}" width="25" height="25"
                        class="d-inline-block align-right">Add Caregiver</span></button>
        </li>
        &nbsp;&nbsp;&nbsp;
        <br>

        <li>
            <button style="width:3.5cm;height:2.1cm"class="btn btn-danger" onclick="location.href='{{route('/')}}'"><img
                        src="{{asset('assets/images/request.png')}}" width="25" height="25"
                        class="d-inline-block align-right">Notification</button>
        </li>
        &nbsp;&nbsp;&nbsp;
    </div>
