...
<head>
    <title>Participant Password Reset Request Page</title>
...
<section class="container-fluid">
    ...
    <div>
        ...
        <p class="text-center h3"style="margin-top: 3%; margin-left: 4cm">Enter your Participant email below</p>
    </div>
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="btn-group-vertical" style=" margin-top:15%; width:100%">
                <ul class="nav flex-column" style="width:100%">
                    ...
                    <li class="nav-item">
                        <p><a class="text-dark nav-link active" aria-current="page"
                                                  href="{{ url('/participantregistration')}}"><img src="{{asset('assets/images/signup.png')}}" width="25" height="25" class="d-inline-block align-right"> Sign Up</a></p>
                    </li>
                    <!-- Patient Login option-->
                    <li class="nav-item">
                        <p><a class="text-dark nav-link active" aria-current="page"
                                                  href="{{ url('/participantlogin')}}"><img src="{{asset('assets/images/key.png')}}" width="25" height="25" class="d-inline-block align-right"> Participant Login</a></p>
                    </li>
    ...
    <section class="row justify-content-center">
        <section class="col-12 col-sm-6 col-md-3">
            <form method = "POST" action = "{{ url('/participantresetrequest')}}">
                @csrf
                <!-- box for email-->
