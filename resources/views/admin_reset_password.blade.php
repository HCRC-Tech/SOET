...
<section class="container-fluid" style="margin-top: 1cm">
    ...
    <ul class="lp">
        <li><button class="block" onclick="location.href='new_participant_registeration'" type="button"><i class='fas fa-user-plus'></i> New Participant Registration Click here to review
            </button></li>
        &nbsp;&nbsp;&nbsp;
        <li><button  class="block" onclick="location.href='admin_reset_password'" type="button"> <i class='fas fa-user-lock'></i> Participant Password Reset Requests. Click here to review
            </button> </li>
        &nbsp;&nbsp;&nbsp;
        <li><a href=""></a> <button  class="block"> <i class='fas fa-pen'></i> View Summary of Participant</button></li>
        &nbsp;&nbsp;&nbsp;
                ...
                <ul class="nav flex-column" style="width:100%">
                    ...
                    <li class="nav-item">
                        <p><a class="text-dark nav-link active" aria-current="page" href="{{ url('/accept/create')}}" >
                                <img src="{{asset('assets/images/request.png')}}" width="25" height="25" class="d-inline-block align-right"> Participant Registration</a></p>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <p ><a class="text-dark nav-link active" aria-current="page" href="{{ url('/profilesearch')}}">
                                <img src="{{asset('assets/images/pen.png')}}" width="25" height="25" class="d-inline-block align-right"> Participant Summary</a></p>
                    </li>
                    <li class="nav-item">
