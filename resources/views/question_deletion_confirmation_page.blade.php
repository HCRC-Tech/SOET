        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="btn-group-vertical" style=" margin-top:15%; width:100%">
                <ul class="nav flex-column" style="width:100%">
                    ...
                    <li class="nav-item">
                        <p><a class="text-dark nav-link active" aria-current="page" href="new_participant_registeration.blade.php"><i class='fas fa-user-plus'></i> new_participant_registeration Registeration</a></p>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <p><a class="text-dark nav-link active" aria-current="page" href="#"><i class='fas fa-pen'></i> Participant Summary</a></p>
                    </li>
                    <li class="nav-item">
