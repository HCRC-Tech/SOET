...
<h4 style="text-align:center;color:blue">Register a new admin</h4>
...
<form style="width: 600px; margin-left:35%; margin-top:0%" method="post" action="{{ url('/adminregistration')}}">
    @csrf
