...
<div id="wrapper">
    ...
    <section class="container-fluid" style="margin-top: .5cm">
        ...
        <div style="margin-left: 3.7cm">
            <p class="text-center h2" style="color:darkblue">Patient Email Verification</p>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="btn-group-vertical" style=" margin-top:15%; width:100%">
                    <ul class="nav flex-column" style="width:100%">
                        ...
                        <li class="nav-item">
                            <p><a class=" text-dark nav-link active" aria-current="page"
                                  href="{{ url('/participantregistration')}}"><img
                        ...
                        <li class="nav-item">
                            <p><a class="text-dark nav-link active" aria-current="page"
                                  href="{{ url('/participantlogin')}}"><img src="{{asset('assets/images/key.png')}}"
                                                                        width="25" height="25"
        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-3">
                <form class="form-container" method="POST" action="{{ url('/participantregistration')}}"
