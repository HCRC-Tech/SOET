...
<h6 style = "text-align:center;color:blue">Here are your tutorials to watch!</h6>
...
@forelse($tutorials as $tutorial)
    ...
    <ul>
      <li style ="display:inline;"><img style="width:200px" onclick="location.href='{{route('/steps/tutorial_id', ['tutorial_id'=>($tutorial->id ?? 0)])}}'"src="{{ asset('assets/images/video.png')}}">
        <p style="color:white;text-align:center;margin-left:-2070px;position:relative;">
          Tutorial: {{$tutorial->group_title}}</p></li>
    </ul>
