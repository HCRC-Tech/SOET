...
<hr>
<h4 style = "text-align:Center;margin-top:-0.5cm">Tutorials</h4>
<h4 style = "text-align:center;color:black">Hello {{$name ?? ''}}</h4>
<h6 style = "text-align:center;color:blue">Click on the image below to wtach tutorial lists</h6>
<div class="container">
        ...
        <div style="margin-left: -10px; margin-top: 60px">
            <ul class="lp">
                ...
                <div class="text-center">
                    <img style="width:6.5cm" src="{{asset('assets/images/Tuitorials.png')}}"class="rounded" 
                    onclick="location.href='{{route('/tutorials')}}'" alt="Tutorials"> 
                </div>
                <li>
            </ul>
        </div>
