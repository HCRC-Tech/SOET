...
<h6 style = "text-align:center;color:black">Here are your tutorials!</h6>
...
@forelse($tutorials as $tutorial)
    <ul>
      <li><img style="width:200px" onclick="location.href='{{url('/')}}steps/{{$tutorial->tutorial_id}}'"src="{{ asset('assets/images/video.png')}}">{{$tutorial->group_title}} ({{$tutorial->tutorial_id}})</li>
    </ul>
@empty
	<p> 
...
<h4 style = "text-align:center;color:black">Debug</h4>
<ul>
  <li>url for /: {{url('/')}}</li>
  <li>route for /: {{route('/')}}</li>
</ul>
